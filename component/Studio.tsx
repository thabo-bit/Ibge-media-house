...
// ── Studio photos ──
const STUDIO_PHOTOS = [
  { src: "/studio-1.jpeg", alt: "Ibge Media House studio — wide view" },
  { src: "/studio-2.jpeg", alt: "Ibge Media House studio — lighting setup" },
  { src: "/studio-3.jpeg", alt: "Ibge Media House studio — camera equipment" },
];

// ── Studio hire packages ──
    ...
    <section className="relative bg-[var(--color-cream)] py-24 sm:py-32 overflow-hidden">
      ...
      >
        ...
        <h2 className="font-serif text-[clamp(2.25rem,5vw,3.75rem)] leading-[1.1] font-light text-[var(--color-ink)]">
          Hire the{" "}
          <em className="italic font-medium text-[#E87C2B]">
            Ibge Studio
          </em>
        </h2>
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 mb-24">
        ...
        <motion.div
          ...
          className="mt-6 relative aspect-video rounded-2xl overflow-hidden shadow-[0_30px_60px_-30px_rgba(31,27,22,0.3)] border border-[var(--color-ink)]/8 bg-black"
        >
          <video
            controls
            playsInline
            preload="metadata"
            poster="/studio-1.jpeg"
      ...
      >
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link
            href="/#contact"
            className="inline-flex items-center justify-center gap-3 border-2 border-[var(--color-ink)] text-[var(--color-ink)] px-8 py-4 text-[11px] font-bold uppercase tracking-[0.25em] hover:bg-[var(--color-ink)] hover:text-[var(--color-cream)] transition-colors duration-300 rounded-sm"
          >
            Send an enquiry
          </Link>
        </div>
